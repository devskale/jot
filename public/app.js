  ...
  function openAgentModal(refs) {
    ...
    if (isOwnerView) {
      lines.push(
        ...
        `toj my-jot read ${currentNoteId}`,
        ``,
        `# Create a note`,
        `toj my-jot create "My note title"`,
        ``,
        `# Edit this note`,
        `toj my-jot edit ${currentNoteId} '[{"oldText":"...","newText":"..."}]'`,
        ``,
        `# Comment on text in this note`,
        `toj my-jot comment ${currentNoteId} "quoted text" "comment body"`,
        ``,
        `# Reply to a specific message`,
        `toj my-jot reply ${currentNoteId} <thread-id> <message-id> "reply"`,
        ``,
        `# Edit or delete a comment`,
        `toj my-jot edit-comment ${currentNoteId} <message-id> "new body"`,
        `toj my-jot delete-comment ${currentNoteId} <message-id>`,
        ``,
        `# Resolve, reopen, or delete a thread`,
        `toj my-jot resolve ${currentNoteId} <thread-id>`,
        `toj my-jot reopen ${currentNoteId} <thread-id>`,
        `toj my-jot delete-thread ${currentNoteId} <thread-id>`,
        ``,
      ...
      lines.push(
        ...
        `toj my-jot edit '[{"oldText":"...","newText":"..."}]'`,
        ``,
        `# Comment on text`,
        `toj my-jot comment "quoted text" "comment body" --name="My Agent"`,
        ``,
        `# Reply to a specific message`,
        `toj my-jot reply <thread-id> <message-id> "reply" --name="My Agent"`,
        ``,
        `# Full command reference`,
        `toj --help`,
      );
